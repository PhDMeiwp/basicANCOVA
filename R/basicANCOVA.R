...
#' View(isotope)
#'
#' ANCOVAplot(x=hotdog$Sodium, y=hotdog$Calories, groups=hotdog$Type,
#'            data=hotdog, Fig.slope = 1) # (same slope) output ANCOVA results and graphic
#'
#' # Not run
#' ANCOVAplot(x=hotdog$Sodium, y=hotdog$Calories, groups=hotdog$Type,
...
#'
#' @author  Weiping Mei
#' @seealso \code{\link[basicTrendline]{trendline}},  \code{\link[ancovaplot]{HH}}
